...
//récupération des variables de session
 ...
 if(empty($adresse) || empty($distance) || empty($selection) ){
    $X= "Tous les champs du formulaire sont obligatoire!";
	header("location: produits.php?mess=$X");
}
...
$categorie="";
	foreach($selection as $key=>$lechoix){
		
		$categorie .=" produit.id_cat = $lechoix OR";
	}
...
WHERE $formule<= $distance and producteur.id_producteur=produit.id_producteur and categorie.id_cat=produit.id_cat and $categorie";
$sql .=" ORDER BY $tri";
