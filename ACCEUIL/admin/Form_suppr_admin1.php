...
<table width="400" border="1">
	...
	<tr><form name="Formulaire_supprad" action="suppr_admin.php" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
		<td><center><strong>Supprimer un admin</strong></center><br/>
			<table width="100%" border="0">
				...
				<tr>
					<td colspan="2">
						<center><button id="edit-submit" class="btn form-submit" type="button" name="supprimer" onCLick="supprAdmin();" value="Supprimer">Supprimer</button></center>
					</td>
